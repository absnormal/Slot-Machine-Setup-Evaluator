...
export default function ToastMessage({ message, type = 'success' }) {
    ...
    return (
        <div className={`fixed bottom-14 right-6 ${bgColor} ${textColor} px-5 py-3.5 rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.3)] font-bold flex items-center gap-3 animate-in slide-in-from-bottom-5 z-[99999] border ${borderColor} backdrop-blur-sm`}>
